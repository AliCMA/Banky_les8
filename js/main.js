...
class BankyLeftSection {
    ...
    makeTransactionsFromData(accountToShow,data){
        ...
        for(let i = 0; i < data[accountToShow].length; i++){
            ...
            this.transactionsElement.append(this.transactionElement);
    ...
    render() {
        ...
        this.leftSectionElement.append(this.transactionsElement);
...
class BankyRightSection {
    ...
    constructor(mainElement) {
        ...
        this.rightSectionElement.classList = "banky__section banky__section";
